class AppStrings {
  // Titles
  static const String gameSettingsTitle = 'НАСТРОЙКИ ИГРЫ';

  // Settings Buttons
  static const String playerCount = 'Количество игроков';
  static const String gameTime = 'Время игры';
  static const String roundCount = 'Количество раундов';
  static const String locationSelection = 'Выбор локации';

  // Location Screen Specific
  static const String randomSelection = 'ВЫБРАТЬ СЛУЧАЙНО';
  static const String confirmAction = 'ПОДТВЕРДИТЬ';
  static const String pleaseSelectWarning = 'Сначала выберете локацию!';
