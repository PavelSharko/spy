...
# Replace group name
dart_code = dart_code.replace('"groupName": "Развлечения и встречи"', '"groupName": "Городские развлечения"')
...
for l in locations:
    ...
    if re.search(role_pattern, dart_code, flags=re.DOTALL):
        ...
        # insert at the end of Городские развлечения section
...
print(f"Updated Group 4 with {len(locations)} locations.")
